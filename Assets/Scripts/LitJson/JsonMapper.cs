    ...
    public class JsonMapper {
        ...
        public static object ReadValue(Type inst_type, JsonReader reader) {
            ...
            if (reader.Token == JsonToken.Double ||
                ...
                if (value_type == intType && json_type == uintType)
                {
                    uint uv = (uint)reader.Value;
                    int v = (int)uv;
                    return v;
                } else if (value_type == uintType && json_type == intType)
                {
            ...
            if (reader.Token == JsonToken.ArrayStart) {
                ...
                while (true) {
                    ...
                    if (t_data.Properties.ContainsKey(property)) {
                        ...
                        object value = ReadValue(t_data.ElementType, reader);
                        try {
                            ((IDictionary)instance).Add(property, value);
                        }
                        catch (Exception e) {
                            UnityEngine.Debug.LogException(new Exception(e.Message + JsonMapper.ToJson(value)));
                        }
